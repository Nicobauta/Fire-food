...
public class Sucursales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        OverlayItem over = new OverlayItem("Branch office 1", "Calle 63f #72-55", Sucursal1);
        over.setMarker(icon);
        puntos.add(over);

        OverlayItem over2 = new OverlayItem("Branch office 2", "Ac. 100 ##49- 54", Sucursal2);
        over2.setMarker(icon);
        puntos.add(over2);

        OverlayItem over3 = new OverlayItem("Branch office 3", "Carrera 34 B # 38-97SUR", Sucursal3);
